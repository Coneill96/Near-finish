...
<head>
 ...
 <body>
 	<div class="uk-section uk-container">
	    ...
	    <div class="uk-margin">
	    	<span class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement="right" title="It would be advised to use the University email that each student is given in their first day of University."></span>
	    ...
	    <div class="uk-margin">
	    	<span class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement="right" title="Password should be over 6 characters."></span>
	        <div class="uk-form-controls">
